#!/bin/bash
  ...
  do
    ...
    /usr/bin/time -v  ./bin/project -m demoSort -i ./tests/test_$l.txt -o ./tests/test_$l.innersort.txt -k $2 &>> ./tests/results_$1.txt;
    echo "Cleaning up...";
    rm ./tests/test*;
    echo "Done.";
    elif [ $1 = "linuxSort" ]; 
    ...
    /usr/bin/time -v sort -g ./tests/test_$l.txt -o ./tests/test_$l.innersort.txt -k $2 &>> ./tests/results_$1.txt;
    echo "Cleaning up...";
    rm ./tests/test*;
    echo "Done.";
    else
